...
values('1111','equ-222','camp-111','un cheque 1000 y una copa mas medallas','primer puesto');
insert into PREMIOS(id_premio,ID_EQUIPO,id_CAMPEONATO,PREMIO,PODIO)
values('2222','equ-333','camp-111','un cheque de 500 y una copa mas medallas','segundo puesto');
